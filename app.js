...
function title(){return({home:'TM-Strojník',machines:'Moje stroje',machineDetail:'Karta stroje',machineForm:'Stroj',service:'Servisní kniha',inspections:'Prohlídky',inspectionForm:'Nová prohlídka',backup:'Záloha dat',logbook:'Provozní deník',logForm:'Nový záznam',logReport:'Výstup pro kontrolu',jobs:'Zakázky',jobForm:'Nová zakázka',fuel:'PHM a tankování',fuelForm:'Nové tankování',shiftStart:'Začít směnu',shiftActive:'Probíhající směna',shiftEnd:'Ukončit směnu',shifts:'Směny',serviceSupplies:'Filtry a kapaliny',supplyForm:'Přidat položku'})[state.route]||'TM-Strojník'}
...
function home(){
 ...
 </div><div class=footer>TM-Strojník v1.1</div>`;
}
...
function render(){const view={home,machines,machineDetail,machineForm,service,inspections,inspectionForm,logbook,logForm,logReport,jobs,jobForm,fuel,fuelForm,shiftStart,shiftActive,shiftEnd,shifts,serviceSupplies,supplyForm,backup}[state.route]||home;document.getElementById('app').innerHTML=shell(view());bind()}
render();