...
render();scrollTo(0,0)}
function title(){return({home:'TM-Strojník',machines:'Moje stroje',machineDetail:'Karta stroje',machineForm:'Stroj',service:'Servisní kniha',inspections:'Prohlídky',inspectionForm:'Nová prohlídka',backup:'Záloha dat',logbook:'Provozní deník',logForm:'Nový záznam',logReport:'Výstup pro kontrolu',jobs:'Zakázky',jobForm:'Nová zakázka',fuel:'PHM a tankování',fuelForm:'Nové tankování',shiftStart:'Začít směnu',shiftActive:'Probíhající směna',shiftEnd:'Ukončit směnu',shifts:'Směny',serviceSupplies:'Filtry a kapaliny',supplyForm:'Přidat položku',alerts:'Upozornění',security:'Zabezpečení'})[state.route]||'TM-Strojník'}
...
function home(){
 ...
 <div class=tiles>
  ...
  ${tile('gray','🔒','Zabezpečení','PIN a zamknutí aplikace','security')}
 </div><div class=footer>TM-Strojník v1.3</div>`;
}
