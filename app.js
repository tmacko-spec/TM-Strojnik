...
const state={route:'home',selected:'',machineSearch:'',machines:load(KEYS.m,defaults),service:load(KEYS.s,[]),inspections:load(KEYS.i,[]),logbook:load(KEYS.l,[]),jobs:load(KEYS.j,[]),fuel:load(KEYS.f,[])};
...
function home(){
 ...
 </div><div class=footer>TM-Strojník v0.9</div>`;
}
