...
function home(){
 ...
 <div class=footer>TM-Strojník v2.6.2</div>`;
}
...
function machineForm(){
 ...
 <div class=group>
  ...
  <div class=category-picker>
   <label class="category-option ${category==='machine'?'selected':''}" data-category="machine">
   ...
   <label class="category-option ${category==='vehicle'?'selected':''}" data-category="vehicle">
